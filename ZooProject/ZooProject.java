...
class Audit{
	...
	void forwardCharge(){
		//sending to database
		return dailyItems[0],dailyCharges[0], i;
...
class healthRecords{
	...
	pastTreatments(treatment){
		String newTreatments = treatment;
		System.out.println(newTreatments);
